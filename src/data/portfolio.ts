...
export const portfolioExperiences = [
  ...
  },
  {
    ...
    shortSummary:
      'Evaluate AI-generated software solutions, identify hidden logic and runtime failures, design tests, compare implementations, and write correctness-focused technical feedback.',
    technologies: ['AI evaluation', 'Code review', 'Software testing', 'Debugging', 'Quality assurance'],
  ...
  },
  {
    ...
    technologies: ['E-commerce analytics', 'Decision modeling', 'Amazon', 'Shopify', 'Process improvement'],
  ...
  },
  {
    ...
    technologies: ['Game design', 'Product design', 'Progression systems', 'Economy design', 'Market research'],
  ...
  },
  {
    ...
    technologies: ['Roblox Studio', 'Lua', 'DataStore', 'Game analytics', 'Live operations'],
  ...
  },
  {
    ...
    shortSummary:
      'Java client-server social application with accounts, profiles, friends, blocking, search, direct messaging, persistent data, desktop UI, and automated tests.',
    technologies: ['Java', 'Client-server architecture', 'Persistence', 'Desktop UI', 'Software testing'],
    highlight: 'Performed most of the implementation and final integration work.',
    metrics: [
  ...
  },
  {
    ...
    technologies: ['Systems engineering', 'Energy analytics', 'Decision modeling', 'Product strategy', 'Financial analysis'],
    highlight: 'Projected campus energy investments through software, engineering, and finance.',
    metrics: [
  ...
  },
  {
    ...
    technologies: ['TypeScript', 'Firebase', 'ESP32', 'PlatformIO', 'C++', 'Embedded systems'],
    highlight: 'Connected a mobile sleep app to a physical alarm clock.',
    metrics: [
      { value: '2', label: 'Codebases' },
  ...
  },
  {
    ...
    technologies: ['Java', 'Minecraft', 'Bukkit', 'Spigot', 'Plugin development', 'Product iteration'],
  ...
  },
  {
    ...
    technologies: ['Discord API', 'Workflow automation', 'Internal tools', 'Hiring operations', 'Bot development'],
    highlight: 'Turned a hiring server into a more structured operating system.',
    showOnWork: true,
    publishCaseStudy: false,
  ...
  },
  {
    ...
    technologies: ['Game analytics', 'Market research', 'Live operations', 'Product strategy', 'Roblox'],
  ...
  },
  {
    ...
    technologies: ['Market research', 'Product strategy', 'Brand strategy', 'Customer journey', 'Competitive analysis'],
