...
export type PortfolioSectionBlock =
  PortfolioParagraphBlock | PortfolioListBlock;
...
export const disciplineLabels: Record<PortfolioDiscipline, string> = {
...
export function getPortfolioDisciplines(
  project: PortfolioExperience,
): PortfolioDiscipline[] {
  if (project.disciplines?.length) return project.disciplines;
  if (project.category === "software") return ["engineering"];
  if (project.category === "studio") return ["product", "leadership"];
  if (project.category === "platform") return ["product"];
  return ["product"];
}
...
export const forestlyGamesCaseStudy = {
  ...
  mediaHighlights: [
    ...
    },
    {
      ...
      poster:
        "https://www.forestlygames.com/games/encaved/encaved-header-poster.jpg",
    },
  ],
  lifecycle: [
    {
...
export const portfolioExperiences = [
  {
    ...
    highlight:
      "Founded ForestlyGames in 2020 and helped turn game concepts into playable releases.",
    metrics: [
  ...
  },
  {
    ...
    shortSummary:
      "Production Next.js platform for studio budgets, staffing, payments, and delivery.",
    problem:
  ...
  },
  {
    ...
    shortSummary:
      "Co-op dungeon fighter with class builds, boss raids, and live event content.",
    problem:
    ...
    takeaway:
      "Led a shipped multiplayer product with progression systems and event-driven retention - relevant to any live service or platform product.",
    highlight:
      "Co-op dungeon fighter with class builds, boss raids, and FNAF-themed live events.",
    metrics: [
      ...
      sections: [
        ...
        },
        {
          ...
          blocks: [
            {
              type: "paragraph",
              text: "Evidence of operating a live game product - not a one-time launch, but ongoing content and systems players return to.",
            },
          ],
        },
      ],
  ...
  },
  {
    ...
    role: "Founder & Product Lead, ForestlyGames",
    shortSummary:
      "Real-time strategy kingdom builder in alpha - villages, troops, and multiplayer combat.",
    problem:
    ...
    takeaway:
      "Shows ability to scope and ship a complex multiplayer product category - strategy, economy, and combat systems under studio constraints.",
    highlight:
      "RTS kingdom builder in alpha - villages, troops, PvP/PvE, and live progression systems.",
    metrics: [
      ...
      sections: [
        ...
        },
        {
          ...
          blocks: [
            {
              type: "paragraph",
              text: "Demonstrates product thinking for systems-heavy games - economy, progression, and multiplayer balance - not just one-off experiences.",
            },
          ],
        },
      ],
  ...
  },
  {
    ...
    shortSummary:
      "Horror survival adventure set in ancient mines - co-op, crafting, and minecart traversal.",
    problem:
    ...
    takeaway:
      "Shows current creative leadership on a flagship title - scoping ambition, art direction, and multi-system gameplay before public launch.",
    highlight:
      "Horror survival in ancient mines - co-op, crafting, minecarts, and a flagship in-development title.",
    metrics: [
      ...
      sections: [
        {
          ...
          blocks: [
            {
              type: "paragraph",
              text: "Encaved is a horror survival adventure through ancient mines filled with monsters, secrets, and unpredictable events. Players ride minecarts, mine resources, upgrade tools, and fight spirits - blending horror with simulator-style progression.",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          blocks: [
            {
              type: "paragraph",
              text: "Demonstrates forward-looking product leadership - shaping a multi-system game before launch, not only shipping what already exists.",
            },
          ],
        },
      ],
  ...
  },
  {
    ...
    role: "Founder & Product Lead, ForestlyGames",
    shortSummary:
      "Pet-powered tycoon where allies accelerate builds and defend against enemy waves.",
    problem:
      "Stand out in the Roblox tycoon genre with a hook that combines base-building and combat pressure.",
    outcome:
      "Active title with pet allies that speed construction and defend bases against waves - positioned for repeat sessions and short-form clips.",
    technologies: ["Product direction", "Game loops", "Live iteration"],
    takeaway:
      "Shows range across genres within one studio - horror, strategy, and tycoon-action hybrids.",
    highlight:
      "Pet-powered tycoon with build acceleration and wave defense - built for clip-friendly sessions.",
    featured: false,
    flagship: false,
    showOnWork: false,
      ...
      sections: [
        ...
        },
        {
          ...
          blocks: [
            {
              type: "paragraph",
              text: "Shows ability to create and operate a platform business - not just write code, but grow usage and facilitate real collaborations.",
            },
          ],
        },
      ],
  ...
  },
  {
    ...
    shortSummary:
      "Review AI-generated code across Python, Java, JavaScript, TypeScript, C#, SQL, Lua, HTML/CSS, Docker, and Git tasks, then identify hidden logic, runtime, setup, and testing failures.",
    technologies: [
      "Python",
      "Java",
      "JavaScript",
    ...
    showOnWork: true,
    publishCaseStudy: false,
    cover: "/images/work/dataannotation/cover.svg",
  },
  {
    slug: "amobant",
    title: "Amobant",
    category: "platform",
    organization: "Amobant",
    status: "Active",
    dates: {
    ...
    showOnWork: true,
    publishCaseStudy: false,
    cover: "/images/work/amobant/cover.svg",
  },
  {
    slug: "independent-game-design",
    title: "Independent Game Design",
    category: "creative",
    status: "Early product work",
    dates: {
      display: "2018-2023",
      timeline: "September 2018 to April 2023",
    },
    role: "Independent Game Designer and Product Contributor",
    shortSummary:
      "Designed Roblox game concepts, progression, economies, engagement loops, market positioning, and practical requirements before ForestlyGames became a larger studio.",
    technologies: [
      "Game design",
      "Product design",
      "Progression systems",
    ...
    highlight: "Learned product design through real player behavior.",
    showOnWork: false,
    publishCaseStudy: false,
    cover: "/images/work/independent-game-design/cover.svg",
  },
  {
    slug: "forestlygames-roblox-backend-systems",
    title: "ForestlyGames Roblox Backend Systems",
    category: "software",
    organization: "ForestlyGames",
    status: "Live game systems",
    dates: {
      display: "2020-Present",
      timeline: "2020 to Present",
    },
    role: "Roblox Backend Engineer and Technical Product Lead",
    shortSummary:
      "Built and directed runtime systems for player persistence, progression, currencies, upgrades, monetization, analytics, onboarding instrumentation, and live operations across Roblox products.",
    technologies: [
      "Roblox Studio",
      "Lua",
      "DataStore",
    ...
    highlight: "The systems behind persistent multiplayer products.",
    metrics: [
      { value: "54M+", label: "Visit portfolio" },
      { value: "Lua", label: "Runtime systems" },
      { value: "Full build", label: "Escape Bruno" },
    ],
    showOnWork: false,
    publishCaseStudy: false,
    cover: "/images/work/roblox-backend-systems/cover.png",
  },
  {
    slug: "bleep",
    title: "Bleep",
    ...
    role: "Java Developer",
    shortSummary:
      "Java client-server social application with accounts, profiles, friends, blocking, search, direct messaging, synchronized persistence, desktop UI, networking, and automated tests.",
    technologies: [
      "Java",
    ...
    showOnWork: true,
    publishCaseStudy: false,
    cover: "/images/work/bleep/cover.png",
    links: {
      github: "https://github.com/Roblemm/Bleep",
    },
  },
  {
  ...
  {
    slug: "rise-n-grind-smart-alarm",
    title: "Rise n Grind Smart Alarm",
    category: "software",
    status: "Prototype",
    dates: {
      display: "2024",
    ...
    role: "Mobile and Embedded Systems Developer",
    shortSummary:
      "Connected a TypeScript mobile alarm experience to a physical ESP32-controlled alarm clock through Firebase, spanning mobile software, cloud state, and embedded firmware.",
    technologies: [
      "TypeScript",
      "Kotlin",
      "Firebase",
    ...
    metrics: [
      { value: "2", label: "Connected codebases" },
      { value: "C++", label: "Embedded firmware" },
      { value: "Firebase", label: "Cloud sync" },
    ],
    showOnWork: true,
    publishCaseStudy: false,
    cover: "/images/work/rise-n-grind/cover.png",
  },
  {
    slug: "give-me-dirt",
    title: "Give Me Dirt",
    ...
    role: "Solo Minecraft Plugin Developer",
    shortSummary:
      "First published Minecraft Bukkit and Spigot plugin with commands, permissions, configurable item discovery, custom recipes, documentation, publishing, and user-driven updates.",
    technologies: [
      "Java",
      "Minecraft",
      "Bukkit",
    ...
    showOnWork: true,
    publishCaseStudy: false,
    cover: "/images/work/give-me-dirt/cover.svg",
    links: {
      live: "https://www.spigotmc.org/resources/give-me-dirt.53737/",
    },
  },
  {
    slug: "forestlygames-discord-bot",
    ...
    disciplines: ["engineering", "operations"],
    highlight:
      "Turned a hiring server into a more structured operating system.",
    showOnWork: true,
    publishCaseStudy: false,
    cover: "/images/work/discord-bot/cover.svg",
  },
  {
    slug: "roscouts",
    title: "RoScouts",
  ...
  },
  {
    ...
    role: "Market Research and Product Strategy Contributor",
    shortSummary:
...
export function getPortfolioExperienceBySlug(
  slug: string,
): PortfolioExperience | undefined {
...
export function getPublishedPortfolioExperiences(): PortfolioExperience[] {
  return portfolioExperiences.filter(
    (project) => project.publishCaseStudy !== false,
  );
}
...
export function getPortfolioWorkGroups() {
  ...
  const featuredProduct = workExperiences.find(
    (project) => project.slug === "forestlygames",
  );
  const featuredEngineering = workExperiences.find(
    (project) => project.slug === "forestlygames-operations-platform",
  );
  const featuredSlugs = new Set(
    [featuredProduct?.slug, featuredEngineering?.slug].filter(
  ...
  const selectedProjects = workExperiences.filter(
    (project) =>
      !featuredSlugs.has(project.slug) && !chapterSlugs.has(project.slug),
  );
